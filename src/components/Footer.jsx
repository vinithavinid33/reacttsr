...
function Footer() {
    return (
        ...
        <footer className="bg-blue-950 w-full pt-16 pb-8">
            <div
                className="grid grid-cols-2 md:grid-cols-3 gap-13 px-8 max-w-7xl mx-auto font-['Work_Sans'] text-sm antialiased">
                <div className="md:col-span-1">
                    ...
                    <p className="text-slate-300 leading-relaxed mb-6 max-w-xs">
                        A legacy of building excellence in Vellore. We specialize in high-
                    ...
                    <div className="flex gap-4">
                        <a className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-on-tertiary-container transition-colors"
                            href="https://www.facebook.com/people/TSR-Groups-Vellore/61583245596538/#">
                            <svg className="relative z-10 fill-white transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
                                <path
                        ...
                        <a className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-on-tertiary-container transition-colors"
                            href="https://youtube.com/@tsr-e1t2f?si=PXOGEJrimgR_FpQk">
                            <span href="javascript:;"
                                className="p-2 rounded-lg flex items-center  justify-center transition-all duration-500  ">
                        ...
                        <a className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-on-tertiary-container transition-colors"
                            href="https://www.instagram.com/tsrgroupsvlr/">
                            <span href="javascript:;"
                                className="p-2 rounded-lg flex items-center  justify-center transition-all duration-500  ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 71 71"
                                    fill="none">
                ...
                <div className="md:col-span-1">
                    <h6 className="text-white font-headline font-bold mb-6 text-base">Our Services</h6>
                    <ul className="space-y-4">
                        <li><Link className="text-slate-300 hover:text-white hover:underline decoration-amber-500 underline-offset-4 transition-colors"
                            to="/projects">Residential Construction</Link></li>
                        <li><Link className="text-slate-300 hover:text-white hover:underline decoration-amber-500 underline-offset-4 transition-colors"
                            to="/projects">Commercial Projects</Link></li>
                        <li><Link className="text-slate-300 hover:text-white hover:underline decoration-amber-500 underline-offset-4 transition-colors"
                            to="/projects">Interior Design</Link></li>
                        <li><Link className="text-slate-300 hover:text-white hover:underline decoration-amber-500 underline-offset-4 transition-colors"
                            to="/projects">Renovations</Link></li>
                    </ul>
                </div>
